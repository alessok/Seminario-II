...
st.markdown("**Desarrolladores:** Alessandro Ledesma & Angelo Montes")
st.markdown("---")
...
if df_clusters_info is not None and df_historico is not None and pronosticos is not None and \
   df_summary is not None and df_mapeo is not None and df_X_procesado is not None:
    ...
    st.sidebar.markdown("• Alessandro Paolo Ledesma Acuña (20204562)")
    st.sidebar.markdown("• Angelo Montes Mamani (20203252)")
    st.sidebar.markdown("---")
